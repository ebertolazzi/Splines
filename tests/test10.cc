...
main() {
  ...
  vec_real_type x = {0, 5, 10, 15, 20, 25, 30, 40, 50, 70};
  vec_real_type y = {0, 0.2, 0.4, 0.6, 0.8, 1, 1.2, 1.4, 1.6};
  ...
  vec_real_type z = {24.2, 24.0, 20.3, 17.3, 14.5, 12.2, 10.2,  5.7,  3.4, 0.1,
  ...
  Splines::SplineSurf * _p_spline1;
  Splines::SplineSurf * _p_spline2;
  Splines::SplineSurf * _p_spline3;
  Splines::SplineSurf * _p_spline4;

  _p_spline1 = new BiQuinticSpline();
  _p_spline2 = new BiQuinticSpline();
  _p_spline3 = new BiQuinticSpline();
  _p_spline4 = new BiQuinticSpline();

  _p_spline1->build(x, y, z, true,  false);
  _p_spline2->build(x, y, z, true,  true );
  _p_spline3->build(x, y, z, false, false);
  _p_spline4->build(x, y, z, false, true );

  _p_spline1->writeToStream(cout);
  cout << "\n\n" << endl;
  _p_spline2->writeToStream(cout);
  cout << "\n\n" << endl;
  _p_spline3->writeToStream(cout);
  cout << "\n\n" << endl;
  _p_spline4->writeToStream(cout);
  cout << "\n\n" << endl;
